...
(function(){
    ...
    (function() {
    var pID = "2505986", n = JSON.parse('[]'), w = window, c = function() {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_2505986||'',
    guid:window.ftGUID_2505986||'',
    confID:window.ftConfID_2505986||'0',
    ftReturn: window.ftReturn_2505986||'',
    keyword:window.ftKeyword_2505986||'',
    ftId:window.ftId_2505986||'',
    ftImpId:window.ftImp2505986 && window.ftImp2505986.impID || '',
    campaignID: '76390',
    cID:'74946',
    pID:'2505986',
    creativeID:'1806273',
    ...
    extscript:[""],
    clickTags: ['http://servedby.flashtalking.com/click/4/76390;2505986;1806273;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=http://www.shoretel.com/find-the-best-business-phone-system/?utm_campaign=JM%20Find%20Your%20Best%20Fit%20Campaign&utm_source=IDG&utm_medium=Display&utm_content=assessment'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?86788614-2505986;1806273;',
    centreAd: true,
    width:300,
    height:250,
    adType:'altimage'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/250/2505986/1806273/image/1806273.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/4/76390;2505986;202;pixel;IDG;SHOR1BestFitQ4FY17IDGTNODContextualBNUS300x250Telecommuting/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/4/76390;2505986;1806273;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=http://www.shoretel.com/find-the-best-business-phone-system/?utm_campaign=JM%20Find%20Your%20Best%20Fit%20Campaign&utm_source=IDG&utm_medium=Display&utm_content=assessment',
    divID:'ftdiv2505986',
    altimgID:'ftalt2505986',
    alttext:'Click here',
    iDeviceImp:'http://servedby.flashtalking.com/imp/4/76390;2505986;207;guid;IDG;SHOR1BestFitQ4FY17IDGTNODContextualBNUS300x250Telecommuting/?ft_guid=',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp2505986 && parseInt(window.ftImp2505986.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m2505986') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m2505986'),
    pageVisible: 'maybe',
